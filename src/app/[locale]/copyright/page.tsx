...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Gakuran Fighting Styles Wiki',
    description: 'Copyright and intellectual property information for Gakuran Fighting Styles Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Gakuran Fighting Styles Wiki',
      description: 'Copyright and intellectual property information for Gakuran Fighting Styles Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Gakuran Fighting Styles Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Gakuran Fighting Styles Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Gakuran Fighting Styles Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox Corporation</strong> - Owner of the Roblox platform</li>
              <li><strong>Gakuran Developers</strong> - Creators of the Gakuran game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li>Character names and fighting styles</li>
            ...
            <ul>
              ...
              <li><strong>Gakuran</strong> - Trademark of the game developers</li>
              <li><strong>Gakuran Fighting Styles Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Gakuran Fighting Styles Wiki.
            </p>
            ...
            <p>
              ...
              Gakuran Fighting Styles Wiki<br />
              Email: <a href="mailto:dmca@gakuranfightingstyles.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gakuranfightingstyles.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Gakuran Fighting Styles Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Gakuran Fighting Styles Wiki (gakuranfightingstyles.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@gakuranfightingstyles.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@gakuranfightingstyles.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@gakuranfightingstyles.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gakuranfightingstyles.wiki</a>
            </p>
            <p>
