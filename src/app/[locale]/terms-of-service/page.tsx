...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://gakuranfightingstyles.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Gakuran Fighting Styles Wiki",
    description: "Read the Terms of Service for Gakuran Fighting Styles Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Gakuran Fighting Styles Wiki",
      title: "Terms of Service - Gakuran Fighting Styles Wiki",
      description: "Terms and conditions for using Gakuran Fighting Styles Wiki.",
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: "Gakuran Fighting Styles Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Gakuran Fighting Styles Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Gakuran Fighting Styles Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Gakuran Fighting Styles Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Gakuran Fighting Styles Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Gakuran". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Codes, fighting style guides, and PvP strategies</li>
              <li>Controls, combos, and combat mechanics</li>
              <li>Character customization and trait information</li>
              <li>Items, accessories, and equipment guides</li>
              <li>Update patch notes and secrets</li>
              <li>Beginner walkthroughs and community discussion</li>
            </ul>
            <p>
              <strong>Important:</strong> Gakuran Fighting Styles Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Gakuran. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Gakuran Fighting Styles Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Gakuran. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Roblox game updates, code expiration, and balance changes may occur without notice. We are not responsible for game changes or expired codes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, GAKURAN FIGHTING STYLES WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Gakuran Fighting Styles Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@gakuranfightingstyles.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@gakuranfightingstyles.wiki</a>
            </p>
            <p>
